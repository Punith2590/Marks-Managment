...
const FacultyConfigurationPage = () => {
    ...
    // A. CO Definitions (New Feature)
    // This replaces the static mock data. Faculty now define this themselves.
    const [coDefinitions, setCoDefinitions] = useState([
        { id: 'CO1', description: 'Understand the basic concepts of System Design.', modules: 'Module 1', kLevel: 'K2' },
        { id: 'CO2', description: 'Analyze the performance of different algorithms.', modules: 'Module 2', kLevel: 'K4' },
        { id: 'CO3', description: 'Apply protocol standards to network architecture.', modules: 'Module 3, Module 4', kLevel: 'K3' },
        { id: 'CO4', description: 'Design a comprehensive billing solution.', modules: 'Module 5', kLevel: 'K6' },
        { id: 'CO5', description: 'Evaluate the ethical implications of AI.', modules: 'Module 5', kLevel: 'K5' },
    ]);

    // B. Global Course Settings
    const [courseSettings, setCourseSettings] = useState({
        targetThreshold: 60, // Student Pass Criteria
        courseType: 'Theory', // Theory, Lab, or Integrated
    });
    ...
    const removeCo = (id) => {
        if (confirm(`Delete ${id}? This will remove it from all assessments.`)) {
    ...
    const removeTool = (id) => {
        if (confirm('Are you sure you want to remove this assessment tool?')) {
    ...
    const handleSave = () => {
        ...
        console.log("Saving Course Config:", {
                    ...
                    {activeTab === 'cos' && (
                        <div className="space-y-6">
                            <Card>
                             ...
                             {/* Global Parameters (Moved to Tab 1 as it relates to Course Setup) */}
                            <Card>
                                <CardHeader>
                                    ...
                                    <Card key={tool.id} className={`transition-all border-l-4 ${!isBalanced ? 'border-amber-400 dark:border-amber-600' : 'border-l-primary-600'}`}>
                                        <CardContent className="p-4 sm:p-6">
                                            <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
                                                ...
                                                {/* Right: CO Distribution (Dynamic based on Tab 1) */}
